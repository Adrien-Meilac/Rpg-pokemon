#include "PKMN_TableMap.h"

PKMN_TableMap::PKMN_TableMap()
{

}

PKMN_TableMap::PKMN_TableMap(std::string FilePath)
{
...
std::ostream& operator<<(std::ostream &flux, PKMN_TableMap const& Table)
{
...
std::vector<int> PKMN_TableMap::dimension() const
{
...
std::vector<std::string> PKMN_TableMap::getLineNames(std::string nameLine) const
{
    return m_headerLine;
}

std::vector<std::string> PKMN_TableMap::getColumnNames(std::string nomColumn) const
{
    return m_headerColumn;
}


std::string PKMN_TableMap::operator()(std::string lineName, std::string columnName) const
{
...
std::vector<std::string> PKMN_TableMap::getLineValues(std::string nameLine) const
{
...
std::vector<std::string> PKMN_TableMap::getColumnValues(std::string nameColumn) const
{
...
std::vector<std::string> PKMN_TableMap::getLineValuesWithLineName(std::string nameLine) const
{
    std::vector<std::string> line;
...
std::vector<std::string> PKMN_TableMap::getColumnValuesWithColumnName(std::string nameColumn) const
{
    std::vector<std::string> column;
